    ...
    <section>
        ...
        <div class="content">
            ...
            <ul id="cameras">
                <li class="camera hidden" id="camera1"><input placeholder="Camera 1"></li>
                <li class="camera hidden" id="camera2"><input placeholder="Camera 2"></li>
            </ul>
        </div>
    </section>
	...
	<script type="text/javascript" src="webUI/1/js/deviceDetector/deviceDetector.js"></script>
